    ...
    <x-slot name="header">
        ...
        <h2 class="bg-white px-8 pt-2">
            <div class="-mb-px flex justify-center">
                ...
                <a class="no-underline text-grey-dark border-b-2 border-transparent uppercase tracking-wide font-semibold text-xs py-3 mr-8" href="{{route('cvs.create')}}"> Registrar um currículo
                ...
                <a class="no-underline text-grey-dark border-b-2 border-transparent uppercase tracking-wide font-semibold text-xs py-3 mr-8" href="{{route('cvs.index')}}"> Visualizar candidatos disponíveis   
                </a>

                <a class="no-underline text-grey-dark border-b-2 border-transparent uppercase tracking-wide font-semibold text-xs py-3" href="{{route('vagas.index')}}">Visualizar vagas disponíveis
