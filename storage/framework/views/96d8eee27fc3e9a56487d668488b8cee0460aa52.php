<nav x-data="{ open: false }" class="white border-b border-white">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('dashboard')); ?>">
                        <img class="w-22 h-16 rounded-full mx-auto" src="<?php echo e(url("storage/generic/nobg.png")); ?>">
...
<?php /**PATH C:\wamp64\www\projetoTcc\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>